...
void MainMenuState::initBackground()
{
	...
	this->title.setPosition(sf::Vector2f((static_cast<float>(this->stateData->window->getSize().x - this->titleTexture.getSize().x * this->title.getScale().x)) / 2.f, static_cast<float>(this->stateData->window->getSize().y) / 40.f));
}
